...
/*
    Implementar VistaTablero (creo que es la unica vista que haria falta
...
*/
    ...
    private void setContenedorAtributos(Jugador jugador){
        ...
        for (AlgoFormer algoformer : jugador.getListaAlgoformers()){
            ...
            movimientosRestantes.setText( "Movimientos restantes: " +
                String.valueOf(algoformer.getMovimientosRestantes()));
            Label distAtaque = new Label();
            distAtaque.setText("Distancia ataque: " +
...
/*
    Se me ocurre que esta funcion es llamada desde los EventHandler de los
    botones que se tocan cuando se eligen algoformers.
...
/*
    El primero es para el alto, el ultimo para el lugar horizontal.
    
    --Joaquin
*/
        contenedorHorizontal.setPadding(new Insets(50,0,50,450));
//      contenedorVertical.setMinHeight(100);
        
        Image imagen = new Image("file:" +
            "src/fiuba/algo3/algoformers/vista/imagenes/intro/FondoGris.jpg",
            300, 0, false, true);
        BackgroundImage imagenDeFondo =
            new BackgroundImage(imagen, BackgroundRepeat.REPEAT,
                BackgroundRepeat.REPEAT, BackgroundPosition.DEFAULT,
...
/*
        ...
        for (int y=0;y<tablero.altura();y++)
            ...
            {
                SuperficieAerea superficieAerea =
                    tablero.getCelda(new Posicion(x,y)).getSuperficieAerea();
                SuperficieTerrestre superficieTerrestre =
                    tablero.getCelda(new Posicion(x,y)).getSuperficieTerrestre();
                Image imagen =
                    new Image(getClass().getResourceAsStream(
                        "src/fiuba/algo3/algoformers/vista/imagenes/" +
                        "escenario/rocoso-nubes.jpg"));
                matriz[y][x]= new Button ("");
